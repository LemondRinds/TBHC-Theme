				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'type' => 'text',
							'desc' => 'Title\'s font size. Requires \'Display Title\' to be checked.<em>Suggested units: px (constant size)</em>',
							'default' => '30px',
						),
						array(
							'name' => __('Title Font Color'),
							'id'   => $prefix . 'title_font_color',
							'type' => 'text',
							'desc' => 'Title\'s font color. Requires \'Display Title\' to be checked.<em>Suggested units: hex (colors)</em>',
							'default' => '#FFFFFF',
						),
						array(
							'name' => __('Title Background Color'),
